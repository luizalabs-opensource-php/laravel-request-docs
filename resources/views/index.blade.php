                    ...
                    <tr class="border">
                        ...
                        <td class="border pl-3 pt-1 pb-1 pr-2 bg-gray-200">
                            ...
                            @foreach ($rules as $rule)
                                @if (str_contains(runTheLast($rule), 'required'))
                        ...
                        <td class="border pl-3 pt-1 pb-1 pr-2">
                            @foreach ($rules as $rule)
                                @if (str_contains(runTheLast($rule), 'integer'))
                                ...
                                @endif
                                @if (str_contains(runTheLast($rule), 'numeric'))
                                ...
                                @endif
                                @if (str_contains(runTheLast($rule), 'string'))
                                ...
                                @endif
                                @if (str_contains(runTheLast($rule), 'json'))
                                ...
                                @endif
                                @if (str_contains(runTheLast($rule), 'array'))
                                ...
                                @endif
                                @if (str_contains(runTheLast($rule), 'date'))
                                ...
                                @endif
                                @if (str_contains(runTheLast($rule), 'boolean'))
                                ...
                                @endif
								@if (str_contains(runTheLast($rule), 'file') || str_contains(runTheLast($rule), 'image'))
                        ...
                        <td class="border pl-3 pt-1 pb-1 pr-2 bg-gray-100 text-center">
                            @foreach ($rules as $rule)
                                @if (str_contains(runTheLast($rule), 'nullable'))
                        ...
                        <td class="border pl-3 pt-1 pb-1 pr-2 text-center">
                            @foreach ($rules as $rule)
                                @if (str_contains(runTheLast($rule), 'bail'))
                        ...
                        <td class="border pl-3 pr-2 break-all">
                            <div class="font-mono">
                                @foreach ($rules as $rule)
                                    @foreach (explode('|', runTheLast($rule)) as $r)
